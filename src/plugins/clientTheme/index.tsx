...
import { waitForComponentByCode, waitForPropsLazy,waitForStoreLazy } from "@webpack";
import { Button, Forms, useStateFromStores } from "@webpack/common";

const ColorPicker = waitForComponentByCode(".Messages.USER_SETTINGS_PROFILE_COLOR_SELECT_COLOR", ".BACKGROUND_PRIMARY)");
...
const { saveClientTheme } = waitForPropsLazy("saveClientTheme");
...
const NitroThemeStore = waitForStoreLazy("ClientThemesBackgroundStore");
