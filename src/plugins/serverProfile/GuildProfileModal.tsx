...
import { waitForExportedComponent, waitForPropsLazy } from "@webpack";
...
const IconClasses = waitForPropsLazy("icon", "acronym", "childWrapper");
const FriendRow = waitForExportedComponent("FriendRow");
