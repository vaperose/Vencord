...
const ChannelRTCStore = waitForStoreLazy("ChannelRTCStore");
const Animations = waitForPropsLazy("a", "animated", "useTransition");
const GuildsBar = waitForComponentByCode('("guildsnav")');
